## Version 0.1.7 - 14.08.2025

### Changements depuis v0.1.6

- Feature/apprise parameters (#3)
...
**Image principale :**
```bash
docker pull ghcr.io/Nonobis/fnd:0.1.7
```
...
- 🏷️ [Tag 0.1.7](ghcr.io/Nonobis/fnd:0.1.7)
